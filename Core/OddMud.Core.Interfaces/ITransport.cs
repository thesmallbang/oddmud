...
namespace OddMud.Core.Interfaces
{
    public interface ITransport
    {
        ...
        Task SendViewCommandsToPlayerAsync(IPlayer player, IViewCommand viewCommand);
        Task SendViewCommandsToMapAsync(IMap map, IViewCommand viewCommand);
        Task SendViewCommandsToMapExceptAsync(IMap map, IEnumerable<IPlayer> players, IViewCommand viewCommand);
        Task SendViewCommandsToMapExceptAsync(IMap map, IPlayer player, IViewCommand viewCommand);
        Task SendViewCommandsToAllAsync(IViewCommand<IViewItem> viewCommand);
        Task SendViewCommandsToAllExceptAsync(IPlayer player, IViewCommand viewCommand);
        Task SendViewCommandsToPlayersAsync(IEnumerable<IPlayer> players, IViewCommand viewCommand);
